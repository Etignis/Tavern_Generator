...
//////////////
    ...
    name += "<a style='float: right; color: rgba(181,218,251, 0.6); padding-right: .4em' href='"+src+"' target='_blanc'><small>Больше имён <i style='position: relative; top: .1em' class='fa fa-external-link' aria-hidden='true'></i></small></a>";
		return name;
	}
	// человек мужчина
	function human_m(n){
	...
	function get_Fine_Wine_drink(){
		var nl1='Фейское вино; Вино "Дикая орхидея";Вино из лотоса;Дворфийское гранатовое вино;Кактусовое вино;Эльфийский мед;Лунный ром;Ягодный бренди;Персиковое вино;Мандариновый бренди;Мандрагоровая настойка;Лимонный мед;"Медовая роса";Ликер лишайниковый;Снежный виски';
	...
	function drink0_type(){
		var nl1='Смузи из слизи;Ивовый чай;Морковный сидр;Абрикосовый сидр;Сливовый сидр; Ягодный сидр; Клюквенный сидр;Пряный яблочный сидр;Коктейль "Семь подземных королей";Коктейль "Дыхание дракона";Мховый шнапс;Драконий кофе - нельзя пить полуросликам ( теряют над собой контроль ); Чай с бармаглотом';
    ...
    var link =  "<br><a href='"+url+"' style='float: right; color: rgba(181,218,251, 0.6); padding-right: .4em' target='_blanc'><small>Больше слухов <i style='position: relative; top: .1em' class='fa fa-external-link' aria-hidden='true'></i></small></a>";
