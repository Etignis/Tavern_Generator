...
var RACE_6_m="Полурослик";//RACE_5_m="Бальд";
var RACE_6_f="Полурослик";//RACE_5_f="Бальда";
var RACE_7_m="Орк";//RACE_5_m="Бальд";
var RACE_7_f="Орк";//RACE_5_f="Бальда";
var RACE_8_m="Гном";//RACE_5_m="Бальд";
var RACE_8_f="Гном";//RACE_5_f="Бальда";
...
//////////////
	...
	function orc_m(n)
	{
		if(n === undefined || n>5 || n<1)
			n=1;
		//console.log("n: "+n);
		var nl1="Гел,Денч,Имш,Кет,Краск,Муррен,Ронт,Токк,Фенг,Хенк,Холг,Шамп";
		//var nl2="Вверхтормашкин,Высокохолм,Галькоброс,Добробочка,Зеленофляг,Кустосбор,Лугодуг,Подветкин,Репейник,Чайнолист";
	...
	function orc_f(n)
	{
		if(n === undefined || n>5 || n<1)
			n=1;
		//console.log("n: "+n);
		var nl1="Багги,Вола,Волен,Евельда,Кансиф,Мев,Нига,Овак,Оунка,Сута,Шаута,Эмен,Энгонг";
		//var nl2="Вверхтормашкин,Высокохолм,Галькоброс,Добробочка,Зеленофляг,Кустосбор,Лугодуг,Подветкин,Репейник,Чайнолис";
	...
	function gnome_m(n)
	{
		if(n === undefined || n>5 || n<1)
			n=1;
		//console.log("n: "+n);
		var nl1="Алвин, Алстон, Боддинок, Брок, Бюргел, Варрин, Вренн, Гербо, Гимбл, Глим, Джебеддо, Димбл, Зук, Келлен, Намфудл, Оррин, Рундар, Сибо, Синдри, Фонкин, Фрюг, Элдон, Эрки";
	...
	function gnome_f(n)
	{
		if(n === undefined || n>5 || n<1)
			n=1;
		//console.log("n: "+n);
		var nl1="Бимпноттин, Брина, Вейуокет, Донелла, Дувамил, Занна, Карамип, Карлин, Лилли, Лорилла, Лупмоттин, Маднаб, Никс, Нисса, Ода, Орла, Ройвин, Тана, Шамил, Эливик, Элиджобелл, Элла";
		var nl2="Берен, Гаррик, Даергел, Мёрниг, Накл, Нингел, Раулнор, Тимберс, Турен, Фолькор, Шеппен";
		var nl3="Барсук, Босоног, Двазамок, Колотушка, Ку, Ним, Пеплосерд, Пивохлёб, Плащ, Пок, Самоцвет, Стамблдак, Фниппер";
	...
	function mus_instr(){
		...
		if(randd(0,2)==0)
		{
			instr+=" и "+n2[1].slice(0, 1).toLowerCase() + n2[1].slice(1);
		}
		return instr;		
	}
	function mus_about(){
	...
	function mus_how(){
		...
		if(rand==0)
		{
			how+=", "+n2[1][0].slice(0, 1).toLowerCase() + n2[1].slice(1)+".";
		}
		if(rand==1)
		{
			how+=", но "+n2[1].slice(0, 1).toLowerCase() + n2[1].slice(1)+".";
		}
