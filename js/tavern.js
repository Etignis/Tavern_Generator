...
//////////////
	...
	function host_race(sex, race){
		...
		sel="<span class='sel_bg'><select id='host_race'>"+option+"</select></span>";
		return sel;
	}
	function host_sex(){
		var nl1="М,Ж";
		...
		sel="<span class='sel_bg'><select id='host_sex'>"+option+"</select></span>";
		return sel;
	}
	function host_age(sex, age){
		...
		sel="<span class='sel_bg'><select id='host_age'>"+option+"</select></span>";
		return sel;
	}
	...
	function host_secret(){
		var ln="Продает рабов из подвала;Есть связь с неким культом;Наследует огромное состояние;Является мэром;Вампир;Разбавляет эль;Есть два супруга, которые не знают друг о друге;Употребляет психотропные вещества";
