...
// Константы //
// (Используютсятолько мужские варианты)
...
//////////////
	...
	function dwarf_m(n)
	{
		if(n === undefined || n>5 || n<1)
			n=1;
		// nl1 - имя; nl2 - фамилия
		var nl1="Терин, Конитир, Гунтраз, Фуганор, Хитдрен, Окино, Бадрик, Кордрек, Реберн, Грантрим, Торелин, Карракис, Донвел, Тромфир, Деребен, Вавек, Мабергор, Скирилат, Дуттрок, Зорлгрум";
	...
	function dwarf_f(n)
	{
		if(n === undefined || n>5 || n<1)
			n=1;
		// nl1 - имя; nl2 - фамилия
		var nl1="Ортиния, Уиннтри, Диесина, Гортрисс, Листра, Ладрейн, Тристрид, Трейка, Пинзла, Делдит, Нориан, Яртрея, Артена, Торера, Хелини, Селтенн, Рунефисс, Геселен, Доа, Нилн";
		var nl2="Жестокобород, Темнокамень, Пьянокровь, Рудобой, Камнеждун, Кузнедух, Камнежуй, Рудолорд, Среброшлем, Руднеглот, Рунощерб, Огнебров, Сталеглот, Кровобород, Камнещит, Пивоног, Песнь Молота, Ковосерд, Камнешлем, Холмодав";
