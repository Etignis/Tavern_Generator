...
//////////////
	...
	function tavern_name(){
		...
		*/
		...
		f_t2=tmp2[0];
		console.log("WTF");
		console.log("ch1 = ch2: "+tmp1[0].charAt(0)+" = "+tmp2[1].charAt(0));
		if(tmp1[0].charAt(0)==tmp2[1].charAt(0))
			f_t2=tmp2[1];
		tav=f_t+f_t2+tmp3;
		console.log("tav: -|"+tav+"|-");
		//return t+" '"+w1+w2+wa+"'";
